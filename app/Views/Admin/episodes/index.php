    ...
    <div class="container-fluid">
        ...
        <div class="card p-3 mt-3">
            <div class="search-input-container">
                ...
                <input type="text" id="episodeSearch"
                ...
                <tbody id="episodeTable">
                    <?php foreach ($episodes as $e): ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($e['poster_img'])): ?>
                                    <img src="<?= BASE_URL ?>/assets/images/<?= htmlspecialchars($e['poster_img']) ?>"
                                        width="50">
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <button class="btn btn-outline-primary btn-sm edit-btn"
                                    ...
                                    data-video="<?= htmlspecialchars($e['video_url']) ?>"
                                    data-poster="<?= htmlspecialchars($e['poster_img']) ?>">
    ...
    <div class="modal-dialog">
        <form method="POST"
            ...
            <div class="modal-body">
                ...
                <select name="season_id" id="seasonSelect"
                ...
                <input type="file" name="video_file"
                    class="form-control mb-3" accept="video/*">
    ...
    <div class="modal-dialog">
        <form method="POST"
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="old_video" id="oldVideo">

                <label class="form-label">Episode Number</label>
                <input type="number" id="editEpisodeNumber"
...
<script>
    ...
    document.querySelectorAll('.edit-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            oldPoster.value = btn.dataset.poster;
            oldVideo.value = btn.dataset.video;
